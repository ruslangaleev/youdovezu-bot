...
- **В git коммитах использовать ТОЛЬКО ASCII символы** - избегать кириллицы и других не-ASCII символов
- **НЕ использовать** сообщения коммитов с кодировочными ошибками типа "РѕРїС‚РёРјРёР·Р°С†РёСЏ"
- **Использовать английский язык** для сообщений коммитов или корректно закодированный текст
